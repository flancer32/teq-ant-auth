...
export default class Fl32_Auth_Back_Act_User_Read {
    ...
    constructor(
         ...
         * @property {Fl32_Auth_Back_Store_RDb_Schema_User.Dto} [rdb] @deprecated use `db` prefix
         * @property {Fl32_Auth_Back_Store_RDb_Schema_Password.Dto} [dbPass]
         * @property {Fl32_Auth_Back_Store_RDb_Schema_User.Dto} [dbUser]
